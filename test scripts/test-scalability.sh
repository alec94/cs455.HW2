...
- This script is useful to students who are testing their code from any of the CS department machines.
...
CLASSES=submission
SCRIPT="cd $CLASSES;
java -cp . cs455.scaling.client.Client denver [server-listening-port]"
